...
class Mensajeenviado
{
     ...
     * Set de
     *
     * @param \GS\UsuarioBundle\Entity\Usuario $de
     * @return Mensajeenviado
     */
    public function setDe(\GS\UsuarioBundle\Entity\Usuario $de = null)
    {
        $this->de = $de;
     ...
     * Set para
     *
     * @param \GS\UsuarioBundle\Entity\Usuario $para
     * @return Mensajeenviado
     */
    public function setPara(\GS\UsuarioBundle\Entity\Usuario $para = null)
    {
        $this->para = $para;
