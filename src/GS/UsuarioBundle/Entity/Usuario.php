 ...
 * @ORM\Entity(repositoryClass="GS\UsuarioBundle\Entity\UsuarioRepository")
 */
class Usuario
{
    /**
     ...
     * Set user
     *
     * @param \GS\UsuarioBundle\Entity\User $user
     * @return Usuario
     */
    public function setUser(\GS\UsuarioBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \GS\UsuarioBundle\Entity\User 
     */
     ...
     *
     * @param \GS\UsuarioBundle\Entity\Tipodocumentoidentidad $tipodocumentoidentidad
     * @return Usuario
     */
    public function setTipodocumentoidentidad(\GS\UsuarioBundle\Entity\Tipodocumentoidentidad $tipodocumentoidentidad = null)
    {
     ...
     *
     * @return \GS\UsuarioBundle\Entity\Tipodocumentoidentidad 
     */
     ...
     * Set tipousuario
     *
     * @param \GS\UsuarioBundle\Entity\Tipousuario $tipousuario
     * @return Usuario
     */
    public function setTipousuario(\GS\UsuarioBundle\Entity\Tipousuario $tipousuario = null)
    {
     ...
     * Get tipousuario
     *
     * @return \GS\UsuarioBundle\Entity\Tipousuario 
     */
