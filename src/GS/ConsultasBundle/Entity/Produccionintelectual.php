 ...
 * @ORM\Entity(repositoryClass="GS\ConsultasBundle\Entity\ProduccionintelectualRepository")
...
class Produccionintelectual
{
     ...
     * Set tipoproduccion
     *
     * @param \GS\ConsultasBundle\Entity\Tipoproduccion $tipoproduccion
     * @return Produccionintelectual
     */
    public function setTipoproduccion(\GS\ConsultasBundle\Entity\Tipoproduccion $tipoproduccion = null)
    {
     ...
     * Get tipoproduccion
     *
     * @return \GS\ConsultasBundle\Entity\Tipoproduccion 
     */
