...
class Mensajeborrado
{
     ...
     * Set de
     *
     * @param \GS\ConsultasBundle\Entity\Usuario $de
     * @return Mensajeborrado
     */
    public function setDe(\GS\ConsultasBundle\Entity\Usuario $de = null)
    {
        $this->de = $de;
     ...
     * Set para
     *
     * @param \GS\ConsultasBundle\Entity\Usuario $para
     * @return Mensajeborrado
     */
    public function setPara(\GS\ConsultasBundle\Entity\Usuario $para = null)
    {
        $this->para = $para;
