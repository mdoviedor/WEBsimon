 ...
 * @ORM\Entity(repositoryClass="GS\ConsultasBundle\Entity\UsuarioRepository")
 */
class Usuario
{
    /**
     ...
     * Set user
     *
     * @param \GS\ConsultasBundle\Entity\User $user
     * @return Usuario
     */
    public function setUser(\GS\ConsultasBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \GS\ConsultasBundle\Entity\User 
     */
     ...
     *
     * @param \GS\ConsultasBundle\Entity\Tipodocumentoidentidad $tipodocumentoidentidad
     * @return Usuario
     */
    public function setTipodocumentoidentidad(\GS\ConsultasBundle\Entity\Tipodocumentoidentidad $tipodocumentoidentidad = null)
    {
     ...
     *
     * @return \GS\ConsultasBundle\Entity\Tipodocumentoidentidad 
     */
     ...
     * Set tipousuario
     *
     * @param \GS\ConsultasBundle\Entity\Tipousuario $tipousuario
     * @return Usuario
     */
    public function setTipousuario(\GS\ConsultasBundle\Entity\Tipousuario $tipousuario = null)
    {
     ...
     * Get tipousuario
     *
     * @return \GS\ConsultasBundle\Entity\Tipousuario 
     */
