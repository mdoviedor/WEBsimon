 ...
 * @ORM\Entity(repositoryClass="GS\ContenidosBundle\Entity\ProduccionintelectualRepository")
 */
class Produccionintelectual
{
     ...
     * Set tipoproduccion
     *
     * @param \GS\ContenidosBundle\Entity\Tipoproduccion $tipoproduccion
     * @return Produccionintelectual
     */
    public function setTipoproduccion(\GS\ContenidosBundle\Entity\Tipoproduccion $tipoproduccion = null)
    {
     ...
     * Get tipoproduccion
     *
     * @return \GS\ContenidosBundle\Entity\Tipoproduccion 
     */
