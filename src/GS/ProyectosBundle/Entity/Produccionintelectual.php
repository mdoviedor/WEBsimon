 ...
 * @ORM\Entity(repositoryClass="GS\ProyectosBundle\Entity\ProduccionintelectualRepository")
 */
class Produccionintelectual
{
    ...
    public function getIdproduccionintelectual()
    {
     ...
     /**
     * Set idproduccionintelectual
     *
     * @param string $idproduccionintelectual
     * @return Produccionintelectual
     */
    public function setIdproduccionintelectual($idproduccionintelectual)
    {
     ...
     * Set tipoproduccion
     *
     * @param \GS\ProyectosBundle\Entity\Tipoproduccion $tipoproduccion
     * @return Produccionintelectual
     */
    public function setTipoproduccion(\GS\ProyectosBundle\Entity\Tipoproduccion $tipoproduccion = null)
    {
     ...
     * Get tipoproduccion
     *
     * @return \GS\ProyectosBundle\Entity\Tipoproduccion 
     */
